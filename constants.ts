...
export const CLASSES: Record<CharacterClass, ClassData> = {
    ...
    bard: {
        ...
        skills: [
            ...
            { id: 'bd7', name: 'Destansı Final (Ulti)', name_en: 'Epic Finale (Ulti)', description: 'Ulti: 500 Hasar + %50 Tüm Statlar (13sn).', description_en: 'Ulti: 500 Dmg + 50% All Stats (13s).', cd: 60, manaCost: 100, levelReq: 25, type: 'ultimate', icon: '/models/icons/bard/icon_symphony_of_destruction_e.png', visual: 'bard_explosion', modelPath: '/models/skills/bard/ult_strings_1.gltf', isAoE: true, duration: 13 },
        ]
    },
    cleric: {
        id: 'cleric',
