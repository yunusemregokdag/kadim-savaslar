  ...
  const GoogleLoginButton = () => (
    <div className="w-full flex justify-center mt-4">
      <GoogleLogin
        ...
        theme="filled_black"
        shape="pill"
        width="300px" // Sabit genişlik yerine %100 de olabilirdi ama Google bazen sorun çıkarıyor, px daha güvenli
        text="continue_with"
        locale="tr"
      />
    </div>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <div className="relative z-10 w-full max-w-md p-8 bg-slate-900/90 border border-slate-700 rounded-xl shadow-2xl backdrop-blur-md">
          ...
          <div className="space-y-4">
            ...
            {/* Google Login Button replaces Guest Login */}
            <GoogleLoginButton />
