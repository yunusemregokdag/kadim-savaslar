...
export const CLASSES: Record<CharacterClass, ClassData> = {
    warrior: {
        ...
        skills: [
            { id: 'w1', name: 'Kılıç Darbesi', name_en: 'Sword Strike', description: 'Temel hasar verir.', description_en: 'Deals basic damage.', cd: 1.0, manaCost: 5, levelReq: 1, type: 'damage', icon: '/models/icons/warrior/icon_brutal_strike.png', visual: 'warrior_slash', modelPath: '/models/skills/warrior/warrior_slash_1.json', isAoE: false },
            { id: 'w2', name: 'Kalkan Duvarı', name_en: 'Shield Wall', description: '3sn hasar almazsın.', description_en: 'Become invulnerable for 3s.', cd: 15, manaCost: 40, levelReq: 3, type: 'buff', icon: '/models/icons/warrior/icon_shield_barrier_e.png', visual: 'warrior_shield', modelPath: '/models/skills/warrior/shield_barrier_1.json' },
            { id: 'w3', name: 'Öfke Patlaması', name_en: 'Rage Burst', description: 'Saldırı gücünü %20 artırır.', description_en: 'Increases attack power by 20%.', cd: 20, manaCost: 30, levelReq: 5, type: 'buff', icon: '/models/icons/warrior/icon_rampage_e.png', visual: 'warrior_charge', modelPath: '/models/skills/warrior/charge_1.json' },
            { id: 'w4', name: 'Yere Vurma', name_en: 'Ground Slam', description: 'Çevredeki düşmanları sersemletir.', description_en: 'Stuns nearby enemies.', cd: 10, manaCost: 25, levelReq: 8, type: 'damage', icon: '/models/icons/warrior/icon_charge_e.png', visual: 'warrior_judgement', modelPath: '/models/skills/warrior/judgement_sword_1.json', isAoE: true },
            { id: 'w5', name: 'Mızrak Atışı', name_en: 'Chain Hook', description: 'Uzaktaki düşmana mızrak fırlatır.', description_en: 'Throws a hook at distant enemy.', cd: 8, manaCost: 20, levelReq: 12, type: 'damage', icon: '/models/icons/warrior/icon_chain_hook_e.png', visual: 'warrior_pierce', modelPath: '/models/skills/warrior/warrior_pierce_1.json', isAoE: false },
            { id: 'w7', name: 'Kıyım (Ulti)', name_en: 'Judgement (Ulti)', description: '360 derece dönerek ölümcül hasar verir.', description_en: 'Deals deadly damage spinning 360 degrees.', cd: 40, manaCost: 60, levelReq: 20, type: 'ultimate', icon: '/models/icons/warrior/icon_judgement_e.png', visual: 'warrior_whirlwind', modelPath: '/models/skills/warrior/whirlwind_1.json', isAoE: true },
        ]
    },
    // --- NEW CLASSES ---
    arctic_knight: {
    ...
    archer: {
        ...
        skills: [
            { id: 'ar1', name: 'Hızlı Atış', name_en: 'Quick Shot', description: 'Seri bir ok atışı.', description_en: 'A rapid arrow shot.', cd: 1.5, manaCost: 10, levelReq: 1, type: 'damage', icon: '/models/icons/archer/icon_quick_shot.png', visual: 'archer_shot', modelPath: '/models/skills/archer/quick_shot.gltf' },
    ...
    archmage: {
        ...
        skills: [
            ...
            { id: 'am2', name: 'Zaman Bükülmesi', name_en: 'Time Warp', description: 'Cooldownları azaltır.', description_en: 'Reduces cooldowns.', cd: 30, manaCost: 50, levelReq: 15, type: 'buff', icon: '/models/icons/archmage/icon_cloak_of_hastur_e.png', visual: 'archmage_impact', modelPath: '/models/skills/archmage/hastur.gltf' },
    ...
    bard: {
        ...
        skills: [
            ...
            { id: 'bd2', name: 'Cesaret Marşı', name_en: 'Anthem of Courage', description: 'Buff: %20 Hasar Artışı. Süre: 15sn.', description_en: 'Buff: +20% Dmg. Dur: 15s.', cd: 15, manaCost: 30, levelReq: 10, type: 'buff', icon: '/models/icons/bard/icon_sound_wave_e.png', visual: 'bard_vibration', modelPath: '/models/skills/bard/blue_bird.gltf', isAoE: true },
            { id: 'bd3', name: 'Yıkım Notası', name_en: 'Note of Ruin', description: 'Debuff: Düşman defansını %30 kırar. Süre: 5sn.', description_en: 'Debuff: Breaks enemy def by 30%. Dur: 5s.', cd: 12, manaCost: 25, levelReq: 12, type: 'utility', icon: '/models/icons/bard/icon_angelic_serenade.png', visual: 'bard_note', modelPath: '/models/skills/bard/black_strings.gltf', isAoE: false },
            { id: 'bd4', name: 'Uyku Ninnisi', name_en: 'Lullaby', description: 'Kitle Kontrol: Düşmanları 3sn uyutur.', description_en: 'CC: Sleeps enemies for 3s.', cd: 25, manaCost: 35, levelReq: 12, type: 'utility', icon: '/models/icons/bard/icon_shield_of_harmony_e.png', visual: 'bard_note', modelPath: '/models/skills/bard/black_strings.gltf', isAoE: true },
            { id: 'bd5', name: 'Hız Rapsodisi', name_en: 'Rhapsody of Speed', description: 'Buff: %30 Hareket Hızı. Süre: 10sn.', description_en: 'Buff: +30% Move Speed. Dur: 10s.', cd: 18, manaCost: 30, levelReq: 10, type: 'buff', icon: '/models/icons/bard/icon_rhapsody_e.png', visual: 'bard_vibration', modelPath: '/models/skills/bard/cupid.gltf', isAoE: true },
            { id: 'bd7', name: 'Destansı Final (Ulti)', name_en: 'Epic Finale (Ulti)', description: 'Ulti: 500 Alan Hasarı + Takıma %50 Buff.', description_en: 'Ulti: 500 AoE Dmg + 50% Team Buff.', cd: 60, manaCost: 100, levelReq: 25, type: 'ultimate', icon: '/models/icons/bard/icon_symphony_of_destruction_e.png', visual: 'bard_explosion', modelPath: '/models/skills/bard/ult_strings_1.gltf', isAoE: true },
        ]
    },
    cleric: {
        id: 'cleric',
        ...
        skills: [
            { id: 'cl1', name: 'Kutsal Işık', name_en: 'Holy Light', description: 'Işık hasarı.', description_en: 'Holy light damage.', cd: 1.0, manaCost: 5, levelReq: 1, type: 'damage', icon: '/models/icons/cleric/icon_divine_punishment_e.png', visual: 'cleric_impact', modelPath: '/models/skills/cleric/divine_cross.gltf', isAoE: false },
            { id: 'cl2', name: 'Büyük Şifa', name_en: 'Greater Heal', description: 'Tekli güçlü iyileştirme.', description_en: 'Strong single target heal.', cd: 8, manaCost: 30, type: 'heal', icon: '/models/icons/cleric/icon_blessing_of_the_white_lantern.png', visual: 'cleric_immolation', modelPath: '/models/skills/cleric/holy_lantern.gltf', isAoE: false },
            { id: 'cl3', name: 'Kutsama', name_en: 'Blessing', description: 'Tüm statları artırır.', description_en: 'Increases all stats.', cd: 30, manaCost: 50, levelReq: 15, type: 'buff', icon: '/models/icons/cleric/icon_luminous_wave_e.png', visual: 'cleric_wave', modelPath: '/models/skills/cleric/god_embodiment.gltf', isAoE: true },
            { id: 'cl4', name: 'Işık Patlaması', name_en: 'Light Burst', description: 'Çevredeki düşmanları kör eder.', description_en: 'Blinds nearby enemies.', cd: 15, manaCost: 30, levelReq: 10, type: 'utility', icon: '/models/icons/cleric/icon_divine_immolation_e.png', visual: 'cleric_impact', modelPath: '/models/skills/cleric/divine_cross.gltf', isAoE: true },
    ...
    martial_artist: {
        ...
        skills: [
            { id: 'ma1', name: 'Seri Yumruk', name_en: 'Rapid Punch', description: 'Hızlı darbeler.', description_en: 'Rapid strikes.', cd: 0.8, manaCost: 5, levelReq: 1, type: 'damage', icon: '/models/icons/martial_artist/icon_agile_strike.png', visual: 'martial_hit', modelPath: '/models/skills/martial_artist/basic_strike_1.json' },
            { id: 'ma2', name: 'Ejderha Tekmesi', name_en: 'Dragon Kick', description: 'Düşmanı uçurur.', description_en: 'Knocks the enemy up.', cd: 10, manaCost: 20, levelReq: 5, type: 'damage', icon: '/models/icons/martial_artist/icon_uppercut_e.png', visual: 'martial_uppercut', modelPath: '/models/skills/martial_artist/uppercut_1.json' },
    ...
    monk: {
        ...
        skills: [
            { id: 'mk1', name: 'Asa Vuruşu', name_en: 'Staff Strike', description: 'Silah hasarı.', description_en: 'Weapon damage.', cd: 1.0, manaCost: 5, levelReq: 1, type: 'damage', icon: '/models/icons/monk/icon_counterstrike_e.png', visual: 'monk_punch', modelPath: '/models/skills/monk/vfx_monk_impact_1.gltf' },
            { id: 'mk2', name: 'Mantra', name_en: 'Mantra', description: 'Koruyucu kalkan.', description_en: 'Protective shield.', cd: 15, manaCost: 30, levelReq: 10, type: 'buff', icon: '/models/icons/monk/icon_beads_of_karma.png', visual: 'monk_meditation', modelPath: '/models/skills/monk/vfx_meditation_beads.gltf' },
