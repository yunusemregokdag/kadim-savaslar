...
export const CLASSES: Record<CharacterClass, ClassData> = {
    warrior: {
        ...
        skills: [
            { id: 'w1', name: 'Kılıç Darbesi', name_en: 'Sword Strike', description: 'Temel hasar verir.', description_en: 'Deals basic damage.', cd: 1.0, manaCost: 5, levelReq: 1, type: 'damage', icon: '/models/icons/warrior/icon_brutal_strike.png', visual: 'warrior_slash', modelPath: '/models/skills/warrior/warrior_slash_1.json' },
            ...
            { id: 'w4', name: 'Yere Vurma', name_en: 'Ground Slam', description: 'Çevredeki düşmanları sersemletir.', description_en: 'Stuns nearby enemies.', cd: 10, manaCost: 25, levelReq: 8, type: 'damage', icon: '/models/icons/warrior/icon_charge_e.png', visual: 'warrior_judgement', modelPath: '/models/skills/warrior/judgement_sword_1.json' },
            { id: 'w5', name: 'Mızrak Atışı', name_en: 'Chain Hook', description: 'Uzaktaki düşmana mızrak fırlatır.', description_en: 'Throws a hook at distant enemy.', cd: 8, manaCost: 20, levelReq: 12, type: 'damage', icon: '/models/icons/warrior/icon_chain_hook_e.png', visual: 'warrior_pierce', modelPath: '/models/skills/warrior/warrior_pierce_1.json' },
    ...
    cleric: {
        ...
        skills: [
            { id: 'cl1', name: 'Kutsal Işık', name_en: 'Holy Light', description: 'Işık hasarı.', description_en: 'Holy light damage.', cd: 1.0, manaCost: 5, levelReq: 1, type: 'damage', icon: '/models/icons/cleric/icon_divine_punishment_e.png', visual: 'cleric_impact', modelPath: '/models/skills/cleric/divine_cross.gltf' },
