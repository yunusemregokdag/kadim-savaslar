...
export const CLASSES: Record<CharacterClass, ClassData> = {
    ...
    bard: {
        ...
        skills: [
            ...
            { id: 'bd2', name: 'Cesaret Marşı', name_en: 'Anthem of Courage', description: 'Buff & Hasar: +%20 Dmg (15sn) + Çevreye Hasar.', description_en: 'Buff & Dmg: +20% Dmg (15s) + AoE Dmg.', cd: 15, manaCost: 30, levelReq: 2, type: 'buff', icon: '/assets/skills/bard_texture/icon_sound_wave.png', visual: 'bard_vibration', modelPath: '/models/skills/bard/blue_bird.gltf', isAoE: true, duration: 15 },
            { id: 'bd3', name: 'Yıkım Notası', name_en: 'Note of Ruin', description: 'Debuff: Düşman defansını %30 kırar (5sn).', description_en: 'Debuff: Breaks enemy def by 30% (5s).', cd: 12, manaCost: 25, levelReq: 4, type: 'utility', icon: '/assets/skills/bard_texture/icon_angelic_serenade.png', visual: 'bard_note', modelPath: '/models/skills/bard/black_strings.gltf', isAoE: false, duration: 5 },
            { id: 'bd4', name: 'Uyku Ninnisi', name_en: 'Lullaby', description: 'CC: Düşmanları 3sn uyutur.', description_en: 'CC: Sleeps enemies for 3s.', cd: 25, manaCost: 35, levelReq: 6, type: 'utility', icon: '/assets/skills/bard_texture/icon_shield_of_harmony.png', visual: 'bard_note', modelPath: '/models/skills/bard/black_strings.gltf', isAoE: true, duration: 3 },
            { id: 'bd5', name: 'Hız Rapsodisi', name_en: 'Rhapsody of Speed', description: 'Buff & Hasar: +%30 Hız (10sn) + Ritmik Hasar.', description_en: 'Buff & Dmg: +30% Speed (10s) + Rhythmic Dmg.', cd: 18, manaCost: 30, levelReq: 8, type: 'buff', icon: '/assets/skills/bard_texture/icon_rhapsody.png', visual: 'bard_vibration', modelPath: '/models/skills/bard/cupid.gltf', isAoE: true, duration: 10 },
