...
export const CLASSES: Record<CharacterClass, ClassData> = {
    ...
    bard: {
        ...
        skills: [
            { id: 'bd1', name: 'Nota Vuruşu', name_en: 'Note Strike', description: 'Ses dalgası hasarı.', description_en: 'Sound wave damage.', cd: 1.0, manaCost: 5, levelReq: 1, type: 'damage', icon: '/models/icons/bard/icon_vibrative_strike_e.png', visual: 'bard_note', modelPath: '/models/skills/bard/strings.gltf' },
            { id: 'bd2', name: 'Cesaret Marşı', name_en: 'Anthem of Courage', description: 'Takımın hasarını artırır.', description_en: 'Increases team damage.', cd: 15, manaCost: 30, levelReq: 10, type: 'buff', icon: '/models/icons/bard/icon_sound_wave_e.png', visual: 'bard_vibration', modelPath: '/models/skills/bard/blue_bird.gltf' },
