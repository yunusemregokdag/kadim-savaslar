...
export const CLASSES: Record<CharacterClass, ClassData> = {
    warrior: {
        ...
        skills: [
            { id: 'w1', name: 'Kılıç Darbesi', name_en: 'Sword Strike', description: 'Hasar: 10 + %100 Fiziksel.', description_en: 'Dmg: 10 + 100% Phys.', cd: 1.0, manaCost: 5, levelReq: 1, type: 'damage', icon: '/assets/skills/warrior_texture/icon_brutal_strike.png', visual: 'warrior_slash', modelPath: '/models/skills/warrior/warrior_slash_1.json', isAoE: false },
            { id: 'w2', name: 'Kalkan Duvarı', name_en: 'Shield Wall', description: 'Buff: 3sn hasar almazsın.', description_en: 'Buff: Invulnerable for 3s.', cd: 15, manaCost: 40, levelReq: 2, type: 'buff', icon: '/assets/skills/warrior_texture/icon_shield_barrier.png', visual: 'warrior_shield', modelPath: '/models/skills/warrior/shield_barrier_1.json', duration: 3 },
            { id: 'w3', name: 'Öfke Patlaması', name_en: 'Rage Burst', description: 'Buff: %20 Saldırı Gücü (10sn).', description_en: 'Buff: +20% Atk Power (10s).', cd: 20, manaCost: 30, levelReq: 4, type: 'buff', icon: '/assets/skills/warrior_texture/icon_rampage.png', visual: 'warrior_charge', modelPath: '/models/skills/warrior/charge_1.json', duration: 10 },
            { id: 'w4', name: 'Yere Vurma', name_en: 'Ground Slam', description: 'Hasar & CC: %150 Dmg + 2sn Sersemlet.', description_en: 'Dmg & CC: 150% Dmg + 2s Stun.', cd: 10, manaCost: 25, levelReq: 6, type: 'damage', icon: '/assets/skills/warrior_texture/icon_charge.png', visual: 'warrior_judgement', modelPath: '/models/skills/warrior/judgement_sword_1.json', isAoE: true, duration: 2 },
            { id: 'w5', name: 'Mızrak Atışı', name_en: 'Chain Hook', description: 'Hasar: %120 Uzak Mesafe Hasarı.', description_en: 'Dmg: 120% Ranged Dmg.', cd: 8, manaCost: 20, levelReq: 8, type: 'damage', icon: '/assets/skills/warrior_texture/icon_chain_hook.png', visual: 'warrior_pierce', modelPath: '/models/skills/warrior/warrior_pierce_1.json', isAoE: false },
            { id: 'w7', name: 'Kıyım (Ulti)', name_en: 'Judgement (Ulti)', description: 'Hasar: 360° Alan, %300 Hasar.', description_en: 'Dmg: 360° AoE, 300% Dmg.', cd: 40, manaCost: 60, levelReq: 10, type: 'ultimate', icon: '/assets/skills/warrior_texture/icon_judgement.png', visual: 'warrior_whirlwind', modelPath: '/models/skills/warrior/whirlwind_1.json', isAoE: true },
        ]
    },
    // --- NEW CLASSES ---
    arctic_knight: {
        ...
        skills: [
            { id: 'ak1', name: 'Buz Kesiği', name_en: 'Frost Strike', description: 'Soğuk hasar verir.', description_en: 'Deals cold damage.', cd: 1.0, manaCost: 5, levelReq: 1, type: 'damage', icon: '/assets/skills/arctic_knight_texture/icon_frost_strike.png', visual: 'arctic_slash', modelPath: '/models/skills/arctic_knight/fx_frost_strike_1.gltf' },
            { id: 'ak2', name: 'Ayaz Zırhı', name_en: 'Frost Armor', description: 'Defansı artırır.', description_en: 'Increases defense.', cd: 15, manaCost: 40, levelReq: 3, type: 'buff', icon: '/assets/skills/arctic_knight_texture/icon_frozen_shield.png', visual: 'arctic_storm', modelPath: '/models/skills/arctic_knight/fx_frost_shield.gltf' },
            { id: 'ak3', name: 'Buz Mızrağı', name_en: 'Ice Lance', description: 'Uzağa buz fırlatır.', description_en: 'Throws an ice lance.', cd: 8, manaCost: 20, levelReq: 5, type: 'damage', icon: '/assets/skills/arctic_knight_texture/icon_permafrost_lance.png', visual: 'arctic_shard', modelPath: '/models/skills/arctic_knight/fx_permafrost_lance.gltf' },
            { id: 'ak4', name: 'Donduran Bakış', name_en: 'Freezing Gaze', description: 'Düşmanları yavaşlatır.', description_en: 'Slows down enemies.', cd: 12, manaCost: 30, levelReq: 8, type: 'utility', icon: '/assets/skills/arctic_knight_texture/icon_frostbite.png', visual: 'arctic_freeze', modelPath: '/models/skills/arctic_knight/fx_frostbite.gltf' },
            { id: 'ak5', name: 'Çığ', name_en: 'Avalanche', description: 'Alana buz hasarı.', description_en: 'Area of effect ice damage.', cd: 15, manaCost: 40, levelReq: 3, type: 'damage', icon: '/assets/skills/arctic_knight_texture/icon_arctic_charge.png', visual: 'arctic_charge', modelPath: '/models/skills/arctic_knight/fx_arctic_charge.gltf' },
            { id: 'ak7', name: 'Kar Fırtınası (Ulti)', name_en: 'Blizzard (Ulti)', description: 'Geniş alan dondurucu hasar.', description_en: 'Massive freezing AoE damage.', cd: 45, manaCost: 80, levelReq: 20, type: 'ultimate', icon: '/assets/skills/arctic_knight_texture/icon_glacier_smash.png', visual: 'arctic_crater', modelPath: '/models/skills/arctic_knight/fx_ice_crater_big.gltf' },
        ]
    },
    archer: {
        id: 'archer',
        ...
        skills: [
            { id: 'ar1', name: 'Hızlı Atış', name_en: 'Quick Shot', description: 'Hasar: %110 Fiziksel.', description_en: 'Dmg: 110% Phys.', cd: 1.5, manaCost: 10, levelReq: 1, type: 'damage', icon: '/assets/skills/archer_texture/icon_quick_shot.png', visual: 'archer_shot', modelPath: '/models/skills/archer/quick_shot.gltf' },
            { id: 'ar2', name: 'Ölümcül Cirit', name_en: 'Deadly Javelin', description: 'Hasar: %200 Kritik Şanslı.', description_en: 'Dmg: 200% High Crit.', cd: 8, manaCost: 30, type: 'damage', icon: '/assets/skills/archer_texture/icon_deadly_javelin.png', visual: 'javelin', modelPath: '/models/skills/archer/javelin.gltf' },
            { id: 'ar3', name: 'Avcı Odağı', name_en: 'Hunters Focus', description: 'Buff: +%30 Kritik Şansı (10sn).', description_en: 'Buff: +30% Crit Chance (10s).', cd: 20, manaCost: 40, levelReq: 12, type: 'buff', icon: '/assets/skills/archer_texture/icon_hunters_focus.png', visual: 'hunters_focus', modelPath: '/models/skills/archer/hunters_focus_1.gltf', duration: 10 },
            { id: 'ar4', name: 'Rüzgar Kesiği', name_en: 'Wind Razor', description: 'Hasar: 3x Vuruş, Her biri %60.', description_en: 'Dmg: 3x Hit, 60% each.', cd: 12, manaCost: 35, type: 'damage', icon: '/assets/skills/archer_texture/icon_windrazor.png', visual: 'archer_volley', modelPath: '/models/skills/archer/archer_bow.gltf' },
            { id: 'ar5', name: 'Geri Adım', name_en: 'Backstep', description: 'Utility: Mesafeyi koru.', description_en: 'Utility: Keep distance.', cd: 15, manaCost: 20, type: 'utility', icon: '/assets/skills/archer_texture/icon_backstep.png', visual: 'backstep', modelPath: '/models/skills/archer/backstep_1.gltf' },
            { id: 'ar6', name: 'Ejder Oku (Ulti)', name_en: 'Dragon Arrow (Ulti)', description: 'Hasar: %500 Delici Hasar.', description_en: 'Dmg: 500% Piercing Dmg.', cd: 50, manaCost: 90, levelReq: 20, type: 'ultimate', icon: '/assets/skills/archer_texture/icon_dragon_piercer.png', visual: 'dragon_arrow', modelPath: '/models/skills/archer/dragon_arrow.gltf' },
        ]
    },
    archmage: {
        id: 'archmage',
        ...
        skills: [
            { id: 'am1', name: 'Arcane Küresi', name_en: 'Arcane Orb', description: 'Hasar: %120 Büyü Hasarı.', description_en: 'Dmg: 120% Magic Dmg.', cd: 1.0, manaCost: 15, type: 'damage', icon: '/assets/skills/archmage_texture/icon_arcane_slash.png', visual: 'archmage_bolt', modelPath: '/models/skills/archmage/arcane_magic_circle.gltf' },
            { id: 'am2', name: 'Zaman Bükülmesi', name_en: 'Time Warp', description: 'Buff: Bekleme Süreleri -%30 (10sn).', description_en: 'Buff: Cooldowns -30% (10s).', cd: 30, manaCost: 50, levelReq: 15, type: 'buff', icon: '/assets/skills/archmage_texture/icon_cloak_of_hastur.png', visual: 'archmage_impact', modelPath: '/models/skills/archmage/hastur.gltf', duration: 10 },
            { id: 'am3', name: 'Polimorf', name_en: 'Polymorph', description: 'CC: Düşmanı kuzuya çevir (3sn).', description_en: 'CC: Hex enemy into sheep (3s).', cd: 20, manaCost: 40, levelReq: 12, type: 'utility', icon: '/assets/skills/archmage_texture/icon_arcane_shield.png', visual: 'archmage_void', modelPath: '/models/skills/archmage/void_chains.gltf', duration: 3 },
            { id: 'am5', name: 'Yıldız Yağmuru', name_en: 'Starfall', description: 'Süreli Hasar: 5sn boyunca saniyede %100.', description_en: 'DoT: 100% per sec for 5s.', cd: 15, manaCost: 60, type: 'damage', icon: '/assets/skills/archmage_texture/icon_meteor_storm.png', visual: 'archmage_meteor', modelPath: '/models/skills/archmage/meteor_storm_meteor.gltf', duration: 5 },
            { id: 'am6', name: 'Mana Patlaması', name_en: 'Mana Burst', description: 'Hasar: %200 Alan Hasarı.', description_en: 'Dmg: 200% AoE Dmg.', cd: 12, manaCost: 45, type: 'damage', icon: '/assets/skills/archmage_texture/icon_blizzard.png', visual: 'archmage_blizzard', modelPath: '/models/skills/archmage/ice_shard.gltf' },
            { id: 'am7', name: 'Kıyamet (Ulti)', name_en: 'Apocalypse (Ulti)', description: 'Hasar: %500 Geniş Alan Yok Edici.', description_en: 'Dmg: 500% Massive AoE Nuke.', cd: 60, manaCost: 120, levelReq: 25, type: 'ultimate', icon: '/assets/skills/archmage_texture/icon_arcane_devastation.png', visual: 'archmage_apocalypse', modelPath: '/models/skills/archmage/meteor_storm_magic_circle.gltf' },
        ]
    },
    bard: {
        id: 'bard',
        ...
        skills: [
            { id: 'bd1', name: 'Nota Vuruşu', name_en: 'Note Strike', description: 'Hasar: 150 + %100 Büyü. Vuruş.', description_en: 'Dmg: 150 + 100% Magic. Strike.', cd: 1.0, manaCost: 5, levelReq: 1, type: 'damage', icon: '/assets/skills/bard_texture/icon_vibrative_strike.png', visual: 'bard_note', modelPath: '/models/skills/bard/strings.gltf', isAoE: false },
            { id: 'bd2', name: 'Cesaret Marşı', name_en: 'Anthem of Courage', description: 'Buff & Hasar: +%20 Dmg (15sn) + Çevreye Hasar.', description_en: 'Buff & Dmg: +20% Dmg (15s) + AoE Dmg.', cd: 15, manaCost: 30, levelReq: 2, type: 'buff', icon: '/assets/skills/bard_texture/icon_sound_wave.png', visual: 'bard_anthem', modelPath: '/models/skills/bard/blue_bird.gltf', isAoE: true, duration: 15 },
            { id: 'bd3', name: 'Yıkım Notası', name_en: 'Note of Ruin', description: 'Debuff: Düşman defansını %30 kırar (5sn).', description_en: 'Debuff: Breaks enemy def by 30% (5s).', cd: 12, manaCost: 25, levelReq: 4, type: 'utility', icon: '/assets/skills/bard_texture/icon_angelic_serenade.png', visual: 'bard_ruin', modelPath: '/models/skills/bard/black_strings.gltf', isAoE: false, duration: 5 },
            { id: 'bd4', name: 'Uyku Ninnisi', name_en: 'Lullaby', description: 'CC: Düşmanları 3sn uyutur.', description_en: 'CC: Sleeps enemies for 3s.', cd: 25, manaCost: 35, levelReq: 6, type: 'utility', icon: '/assets/skills/bard_texture/icon_shield_of_harmony.png', visual: 'bard_lullaby', modelPath: '/models/skills/bard/black_strings.gltf', isAoE: true, duration: 3 },
            { id: 'bd5', name: 'Hız Rapsodisi', name_en: 'Rhapsody of Speed', description: 'Buff & Hasar: +%30 Hız (10sn) + Ritmik Hasar.', description_en: 'Buff & Dmg: +30% Speed (10s) + Rhythmic Dmg.', cd: 18, manaCost: 30, levelReq: 8, type: 'buff', icon: '/assets/skills/bard_texture/icon_rhapsody.png', visual: 'bard_speed', modelPath: '/models/skills/bard/cupid.gltf', isAoE: true, duration: 10 },
            { id: 'bd7', name: 'Destansı Final (Ulti)', name_en: 'Epic Finale (Ulti)', description: 'Ulti: 500 Hasar + %50 Statlar (13sn).', description_en: 'Ulti: 500 Dmg + 50% Stats (13s).', cd: 60, manaCost: 100, levelReq: 10, type: 'ultimate', icon: '/assets/skills/bard_texture/icon_symphony_of_destruction.png', visual: 'bard_explosion', modelPath: '/models/skills/bard/ult_strings_1.gltf', isAoE: true, duration: 13 },
        ]
    },
    cleric: {
        id: 'cleric',
        ...
        skills: [
            { id: 'cl1', name: 'Kutsal Işık', name_en: 'Holy Light', description: 'Hasar: %120 Işık Hasarı.', description_en: 'Dmg: 120% Holy Dmg.', cd: 1.0, manaCost: 5, levelReq: 1, type: 'damage', icon: '/assets/skills/cleric_texture/icon_divine_punishment.png', visual: 'cleric_impact', modelPath: '/models/skills/cleric/divine_cross.gltf', isAoE: false },
            { id: 'cl2', name: 'Büyük Şifa', name_en: 'Greater Heal', description: 'Heal/Dmg: Dosta Şifa, Düşmana Hasar.', description_en: 'Heal/Dmg: Heal Ally, Damage Enemy.', cd: 8, manaCost: 30, type: 'heal', icon: '/assets/skills/cleric_texture/icon_blessing_of_the_white_lantern.png', visual: 'cleric_immolation', modelPath: '/models/skills/cleric/holy_lantern.gltf', isAoE: false },
            { id: 'cl3', name: 'Kutsama', name_en: 'Blessing', description: 'Buff & Yakma: +%20 Stat (20sn) + Alev.', description_en: 'Buff & Burn: +20% Stats (20s) + Fire.', cd: 30, manaCost: 50, levelReq: 2, type: 'buff', icon: '/assets/skills/cleric_texture/icon_luminous_wave.png', visual: 'cleric_wave', modelPath: '/models/skills/cleric/god_embodiment.gltf', isAoE: true, duration: 20 },
            { id: 'cl4', name: 'Işık Patlaması', name_en: 'Light Burst', description: 'CC: Çevreyi Kör Et (3sn).', description_en: 'CC: Blind Nearby (3s).', cd: 15, manaCost: 30, levelReq: 6, type: 'utility', icon: '/assets/skills/cleric_texture/icon_divine_immolation.png', visual: 'cleric_impact', modelPath: '/models/skills/cleric/divine_cross.gltf', isAoE: true, duration: 3 },
            { id: 'cl5', name: 'Diriltme (Pasif)', name_en: 'Resurrection (Passive)', description: 'Pasif: Ölümden korur (120sn CD).', description_en: 'Passive: Prevent death (120s CD).', cd: 120, manaCost: 0, levelReq: 8, type: 'utility', icon: '/assets/skills/cleric_texture/icon_dawnbringer_angel.png', visual: 'cleric_tear', modelPath: '/models/skills/cleric/dawnbringer_angel.gltf' },
            { id: 'cl7', name: 'Tanrısal Müdahale (Ulti)', name_en: 'Divine Intervention (Ulti)', description: 'Heal & Dmg: %100 HP + Alan Hasarı.', description_en: 'Heal & Dmg: 100% HP + AoE Dmg.', cd: 90, manaCost: 100, levelReq: 10, type: 'ultimate', icon: '/assets/skills/cleric_texture/icon_divine_cross.png', visual: 'cleric_tear', modelPath: '/models/skills/cleric/tear_of_god.gltf', isAoE: true },
        ]
    },
    martial_artist: {
        id: 'martial_artist',
        ...
        skills: [
            { id: 'ma1', name: 'Seri Yumruk', name_en: 'Rapid Punch', description: 'Hasar: %80 Sersemletici Vuruş.', description_en: 'Dmg: 80% Stunning Strike.', cd: 0.8, manaCost: 5, levelReq: 1, type: 'damage', icon: '/assets/skills/martial_artist_texture/icon_agile_strike.png', visual: 'martial_hit', modelPath: '/models/skills/martial_artist/basic_strike_1.json' },
            { id: 'ma2', name: 'Ejderha Tekmesi', name_en: 'Dragon Kick', description: 'CC: Havaya Savur (1.5sn).', description_en: 'CC: Knockup (1.5s).', cd: 10, manaCost: 20, levelReq: 5, type: 'damage', icon: '/assets/skills/martial_artist_texture/icon_uppercut.png', visual: 'martial_uppercut', modelPath: '/models/skills/martial_artist/uppercut_1.json', duration: 1.5 },
            { id: 'ma3', name: 'Meditasyon', name_en: 'Meditation', description: 'Heal: 5sn boyunca %50 HP.', description_en: 'Heal: 50% HP over 5s.', cd: 30, manaCost: 0, type: 'heal', icon: '/assets/skills/martial_artist_texture/icon_evasion.png', visual: 'martial_evasion', modelPath: '/models/skills/martial_artist/evasion_1.json', duration: 5 },
            { id: 'ma4', name: 'Kaplan Duruşu', name_en: 'Tiger Stance', description: 'Buff: +%40 Saldırı Gücü (15sn).', description_en: 'Buff: +40% Atk Power (15s).', cd: 20, manaCost: 30, type: 'buff', icon: '/assets/skills/martial_artist_texture/icon_double_strike.png', visual: 'martial_multi', modelPath: '/models/skills/martial_artist/multi_strike_1.json', duration: 15 },
            { id: 'ma5', name: 'Turna Kanadı', name_en: 'Crane Wing', description: 'Hasar: %150 Alan Hasarı.', description_en: 'Dmg: 150% AoE Dmg.', cd: 12, manaCost: 25, type: 'damage', icon: '/assets/skills/martial_artist_texture/icon_deadly_squash.png', visual: 'martial_slash', modelPath: '/models/skills/martial_artist/deadly_squash.json' },
            { id: 'ma7', name: 'Yedi Yıldız (Ulti)', name_en: 'Seven Stars (Ulti)', description: 'Hasar: 7 Vuruşluk Ölümcül Kombo.', description_en: 'Dmg: 7-Hit Lethal Combo.', cd: 50, manaCost: 80, type: 'ultimate', icon: '/assets/skills/martial_artist_texture/icon_multi_strike.png', visual: 'martial_ultimate', modelPath: '/models/skills/martial_artist/multi_strike_1.json' },
        ]
    },
    reaper: {
        id: 'reaper',
        ...
        skills: [
            { id: 'rp1', name: 'Tırpan', name_en: 'Scythe Slash', description: 'Geniş biçme hareketi.', description_en: 'Wide slashing movement.', cd: 1.2, manaCost: 10, levelReq: 1, type: 'damage', icon: '/assets/skills/reaper_texture/icon_soul_scythe.png', visual: 'reaper_slice', modelPath: '/models/skills/reaper/death_slice_1.json' },
            { id: 'rp2', name: 'Ölüm Dokunuşu', name_en: 'Death Touch', description: 'Zamanla hasar verir.', description_en: 'Deals damage over time.', cd: 10, manaCost: 20, levelReq: 5, type: 'damage', icon: '/assets/skills/reaper_texture/icon_reaping_claw.png', visual: 'reaper_soul_slice', modelPath: '/models/skills/reaper/soul_slice_1.json' },
            { id: 'rp3', name: 'Ruh Hasadı', name_en: 'Soul Harvest', description: 'Düşmandan can çalar.', description_en: 'Steals health from enemy.', cd: 12, manaCost: 30, levelReq: 8, type: 'heal', icon: '/assets/skills/reaper_texture/icon_soul_slice.png', visual: 'reaper_wave', modelPath: '/models/skills/reaper/soul_wave_1.json' },
            { id: 'rp4', name: 'Karanlık Geçit', name_en: 'Dark Passage', description: 'Gölgelerin içinden geçer.', description_en: 'Passes through shadows.', cd: 15, manaCost: 25, type: 'utility', icon: '/assets/skills/reaper_texture/icon_surge.png', visual: 'reaper_spin', modelPath: '/models/skills/reaper/death_spin.json' },
