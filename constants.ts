...
export const CLASSES: Record<CharacterClass, ClassData> = {
    warrior: {
        ...
        skills: [
            ...
            { id: 'w2', name: 'Kalkan Duvarı', name_en: 'Shield Wall', description: 'Buff: 3sn hasar almazsın.', description_en: 'Buff: Invulnerable for 3s.', cd: 15, manaCost: 40, levelReq: 3, type: 'buff', icon: '/models/icons/warrior/icon_shield_barrier_e.png', visual: 'warrior_shield', modelPath: '/models/skills/warrior/shield_barrier_1.json', duration: 3 },
            { id: 'w3', name: 'Öfke Patlaması', name_en: 'Rage Burst', description: 'Buff: %20 Saldırı Gücü (10sn).', description_en: 'Buff: +20% Atk Power (10s).', cd: 20, manaCost: 30, levelReq: 5, type: 'buff', icon: '/models/icons/warrior/icon_rampage_e.png', visual: 'warrior_charge', modelPath: '/models/skills/warrior/charge_1.json', duration: 10 },
            { id: 'w4', name: 'Yere Vurma', name_en: 'Ground Slam', description: 'Hasar & CC: %150 Dmg + 2sn Sersemlet.', description_en: 'Dmg & CC: 150% Dmg + 2s Stun.', cd: 10, manaCost: 25, levelReq: 8, type: 'damage', icon: '/models/icons/warrior/icon_charge_e.png', visual: 'warrior_judgement', modelPath: '/models/skills/warrior/judgement_sword_1.json', isAoE: true, duration: 2 },
            { id: 'w5', name: 'Mızrak Atışı', name_en: 'Chain Hook', description: 'Hasar: %120 Uzak Mesafe Hasarı.', description_en: 'Dmg: 120% Ranged Dmg.', cd: 8, manaCost: 20, levelReq: 12, type: 'damage', icon: '/models/icons/warrior/icon_chain_hook_e.png', visual: 'warrior_pierce', modelPath: '/models/skills/warrior/warrior_pierce_1.json', isAoE: false },
            { id: 'w7', name: 'Kıyım (Ulti)', name_en: 'Judgement (Ulti)', description: 'Hasar: 360° Alan, %300 Hasar.', description_en: 'Dmg: 360° AoE, 300% Dmg.', cd: 40, manaCost: 60, levelReq: 20, type: 'ultimate', icon: '/models/icons/warrior/icon_judgement_e.png', visual: 'warrior_whirlwind', modelPath: '/models/skills/warrior/whirlwind_1.json', isAoE: true },
        ]
    },
    // --- NEW CLASSES ---
    arctic_knight: {
    ...
    bard: {
        ...
        skills: [
            ...
            { id: 'bd2', name: 'Cesaret Marşı', name_en: 'Anthem of Courage', description: 'Buff: %20 Hasar Artışı (15sn).', description_en: 'Buff: +20% Dmg (15s).', cd: 15, manaCost: 30, levelReq: 10, type: 'buff', icon: '/models/icons/bard/icon_sound_wave_e.png', visual: 'bard_vibration', modelPath: '/models/skills/bard/blue_bird.gltf', isAoE: true, duration: 15 },
            { id: 'bd3', name: 'Yıkım Notası', name_en: 'Note of Ruin', description: 'Debuff: Düşman defansını %30 kırar (5sn).', description_en: 'Debuff: Breaks enemy def by 30% (5s).', cd: 12, manaCost: 25, levelReq: 12, type: 'utility', icon: '/models/icons/bard/icon_angelic_serenade.png', visual: 'bard_note', modelPath: '/models/skills/bard/black_strings.gltf', isAoE: false, duration: 5 },
            { id: 'bd4', name: 'Uyku Ninnisi', name_en: 'Lullaby', description: 'CC: Düşmanları 3sn uyutur.', description_en: 'CC: Sleeps enemies for 3s.', cd: 25, manaCost: 35, levelReq: 12, type: 'utility', icon: '/models/icons/bard/icon_shield_of_harmony_e.png', visual: 'bard_note', modelPath: '/models/skills/bard/black_strings.gltf', isAoE: true, duration: 3 },
            { id: 'bd5', name: 'Hız Rapsodisi', name_en: 'Rhapsody of Speed', description: 'Buff: %30 Hareket Hızı (10sn).', description_en: 'Buff: +30% Move Speed (10s).', cd: 18, manaCost: 30, levelReq: 10, type: 'buff', icon: '/models/icons/bard/icon_rhapsody_e.png', visual: 'bard_vibration', modelPath: '/models/skills/bard/cupid.gltf', isAoE: true, duration: 10 },
            { id: 'bd7', name: 'Destansı Final (Ulti)', name_en: 'Epic Finale (Ulti)', description: 'Ulti: 500 Hasar + %50 Tüm Statlar (20sn).', description_en: 'Ulti: 500 Dmg + 50% All Stats (20s).', cd: 60, manaCost: 100, levelReq: 25, type: 'ultimate', icon: '/models/icons/bard/icon_symphony_of_destruction_e.png', visual: 'bard_explosion', modelPath: '/models/skills/bard/ult_strings_1.gltf', isAoE: true, duration: 20 },
        ]
    },
    cleric: {
        id: 'cleric',
        ...
        skills: [
            ...
            { id: 'cl2', name: 'Büyük Şifa', name_en: 'Greater Heal', description: 'Heal: 300 + %200 Büyü Gücü.', description_en: 'Heal: 300 + 200% Magic Power.', cd: 8, manaCost: 30, type: 'heal', icon: '/models/icons/cleric/icon_blessing_of_the_white_lantern.png', visual: 'cleric_immolation', modelPath: '/models/skills/cleric/holy_lantern.gltf', isAoE: false },
            { id: 'cl3', name: 'Kutsama', name_en: 'Blessing', description: 'Buff: +%20 Tüm Statlar (20sn).', description_en: 'Buff: +20% All Stats (20s).', cd: 30, manaCost: 50, levelReq: 15, type: 'buff', icon: '/models/icons/cleric/icon_luminous_wave_e.png', visual: 'cleric_wave', modelPath: '/models/skills/cleric/god_embodiment.gltf', isAoE: true, duration: 20 },
            { id: 'cl4', name: 'Işık Patlaması', name_en: 'Light Burst', description: 'CC: Çevreyi Kör Et (3sn).', description_en: 'CC: Blind Nearby (3s).', cd: 15, manaCost: 30, levelReq: 10, type: 'utility', icon: '/models/icons/cleric/icon_divine_immolation_e.png', visual: 'cleric_impact', modelPath: '/models/skills/cleric/divine_cross.gltf', isAoE: true, duration: 3 },
            { id: 'cl5', name: 'Diriltme (Pasif)', name_en: 'Resurrection (Passive)', description: 'Pasif: Ölümden korur (120sn CD).', description_en: 'Passive: Prevent death (120s CD).', cd: 120, manaCost: 0, type: 'utility', icon: '/models/icons/cleric/icon_dawnbringer_angel.png', visual: 'cleric_tear', modelPath: '/models/skills/cleric/dawnbringer_angel.gltf' },
            { id: 'cl7', name: 'Tanrısal Müdahale (Ulti)', name_en: 'Divine Intervention (Ulti)', description: 'Heal: %100 HP (Takım).', description_en: 'Heal: 100% HP (Team).', cd: 90, manaCost: 100, levelReq: 25, type: 'ultimate', icon: '/models/icons/cleric/icon_divine_cross_e.png', visual: 'cleric_tear', modelPath: '/models/skills/cleric/tear_of_god.gltf', isAoE: true },
        ]
    },
    martial_artist: {
        id: 'martial_artist',
